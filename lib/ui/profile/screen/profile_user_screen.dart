...
class ProfileUserScreen extends GetView<ProfileUserController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: buildBody(brightness, context),
    );
  }
  ...
  AppBar buildAppBar(ThemeData themeData, BuildContext context) {
    return AppBar(
      ...
      actions: [
        buildSearchAction(themeData, context),
        buildSettingsAction(context),
      ],
    );
  }

  Widget buildSearchAction(ThemeData themeData, BuildContext context) {
    return Padding(
  ...
  Widget buildSettingsAction(BuildContext context) {
    return Padding(
      ...
      child: InkWell(
        onTap: () => Get.bottomSheet(buildBottomSheet(context)),
        child: const Icon(
          Icons.settings,
          color: Colors.white,
          size: 35,
  ...
  Widget buildBody(Brightness brightness, BuildContext context) {
